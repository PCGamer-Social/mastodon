    ...
    if (multiColumn) {
      ...
      header = (
        <nav className='drawer__header'>
          ...
          <a href='/about/more' className='drawer__tab' title={intl.formatMessage(messages.info)} aria-label={intl.formatMessage(messages.info)}><Icon id='question' fixedWidth /></a>
